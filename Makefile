...
gen-proto:
	...
	protoc --proto_path=protos/order_service --go_out=${CURRENT_DIR}/genproto/order_product_service --go_opt=paths=source_relative --go-grpc_out=${CURRENT_DIR}/genproto/order_product_service --go-grpc_opt=paths=source_relative protos/order_service/order_products.proto
	protoc --proto_path=protos/order_service --go_out=${CURRENT_DIR}/genproto/order_notes --go_opt=paths=source_relative --go-grpc_out=${CURRENT_DIR}/genproto/order_notes --go-grpc_opt=paths=source_relative protos/order_service/order_status_notes.proto
