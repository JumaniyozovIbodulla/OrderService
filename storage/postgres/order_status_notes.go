...
func (o *orderNotesRepo) Create(ctx context.Context, req *orn.CreateOrderNotes) (resp *orn.OrderNotes, err error) {
	id := uuid.New()
...
func (o *orderNotesRepo) GetById(ctx context.Context, req *orn.OrderNotesPrimaryKey) (resp *orn.OrderNotes, err error) {
	resp = &orn.OrderNotes{}
...
func (o *orderNotesRepo) GetAll(ctx context.Context, req *orn.GetListOrderNotesRequest) (resp *orn.GetListOrderNotesResponse, err error) {
...
func (o *orderNotesRepo) Update(ctx context.Context, req *orn.UpdateOrderNotes) (resp *orn.OrderNotes, err error) {
	resp = &orn.OrderNotes{}
	paymentStatus := PaymentEnumToPostgreSQL(req.Status)
...
func (o *orderNotesRepo) Delete(ctx context.Context, req *orn.OrderNotesPrimaryKey) (resp *orn.Empty, err error) {
	resp = &orn.Empty{}
