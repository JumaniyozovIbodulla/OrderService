...
func (x *OrderProduct) GetDeletedAt() int64 {
	if x != nil {
		return x.DeletedAt
	}
	return 0
...
func (x *GetListOrderProductRequest) GetSearch() string {
	if x != nil {
		return x.Search
	}
	return ""
...
var file_order_products_proto_rawDesc = []byte{
	...
	0x22, 0x28, 0x0a, 0x16, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x4b, 0x65, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0xa1, 0x01, 0x0a, 0x12, 0x43,
	...
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0xc0,
	...
	0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0d, 0x64, 0x69,
	0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x70,
	0x72, 0x69, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63,
	0x65, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20,
	...
	0x74, 0x22, 0xd0, 0x01, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65,
	...
	0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64,
	0x5f, 0x61, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x64, 0x41, 0x74, 0x22, 0x62, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x4f,
	...
	0x52, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x22, 0x77, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x4c,
...
var file_order_products_proto_depIdxs = []int32{
	7, // 0: order_products.OrderProduct.created_at:type_name -> google.protobuf.Timestamp
	7, // 1: order_products.OrderProduct.updated_at:type_name -> google.protobuf.Timestamp
	3, // 2: order_products.GetListOrderProductResponse.OrderProducts:type_name -> order_products.OrderProduct
	2, // 3: order_products.OrderProducts.Create:input_type -> order_products.CreateOrderProduct
	1, // 4: order_products.OrderProducts.GetById:input_type -> order_products.OrderProductPrimaryKey
	5, // 5: order_products.OrderProducts.GetAll:input_type -> order_products.GetListOrderProductRequest
	4, // 6: order_products.OrderProducts.Update:input_type -> order_products.UpdateOrderProduct
	1, // 7: order_products.OrderProducts.Delete:input_type -> order_products.OrderProductPrimaryKey
	3, // 8: order_products.OrderProducts.Create:output_type -> order_products.OrderProduct
	3, // 9: order_products.OrderProducts.GetById:output_type -> order_products.OrderProduct
	6, // 10: order_products.OrderProducts.GetAll:output_type -> order_products.GetListOrderProductResponse
	3, // 11: order_products.OrderProducts.Update:output_type -> order_products.OrderProduct
	0, // 12: order_products.OrderProducts.Delete:output_type -> order_products.Empty
